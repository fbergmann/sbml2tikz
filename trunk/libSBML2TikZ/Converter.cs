...
namespace SBML2TikZ
{
    ...
    public class Converter
    {
        ...
        {
            if (layout != null && layout._EmlRenderInformation.Count != 0 && layoutNum < SBMLExtension.Util.Layouts.Count && !layout.Dimensions.IsZero)
            {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.AppendLine("% This TeX file was generated by SBML2TikZ Version: " + Assembly.GetExecutingAssembly().GetName().Version.ToString());
        ...
        private void WriteTo(IndentedTextWriter writer, Layout selectedLayout)
        {
            ...
            writer.WriteLine("% This TeX file was generated by SBML2TikZ Version: {0}", Assembly.GetExecutingAssembly().GetName().Version.ToString());
